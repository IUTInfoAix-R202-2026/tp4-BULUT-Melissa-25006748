...
public class PokemonViewModel {
  ...
  public void ajouter() {
    ...
    service
        ...
        .ifPresentOrElse(
            pokemonTrouve -> {
              if (pokemons.contains(pokemonTrouve)) {
                statut.set("Ce Pokémon est déjà dans votre Pokédex !");
              } else {
                // Sinon on l'ajoute et on vide la barre de recherche
                pokemons.add(pokemonTrouve);
                recherche.set("");
              }
            },
